...
const ReviewForm = ({ servicetitle }) => {
    ...
    const handleReviewadded = event => {
        ...
        fetch('https://dental-service-server.vercel.app/reviews', {
            method: 'POST',
            headers: {
                                    ...
                                    <div className="grid grid-cols-6 gap-6">
                                        ...
                                        <div className="col-span-6">
                                            <div className="space-y-1 text-sm">
                                                ...
                                                <input type="text" name="image" id="image" placeholder="Service Picture" className="w-full px-4 py-3 rounded-md dark:border-gray-700text-black focus:dark:border-violet-400 outline-none" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
